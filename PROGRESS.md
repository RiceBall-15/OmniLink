...
- ⏳ 在线状态同步 ✅ (已有实现: status_manager.rs, presence_channel.rs)
- ⏳ 文件下载功能 ✅ (已有实现: file-service/handlers.rs)
- ⏳ 图片预览 ✅ (已有实现: file-service 缩略图功能)
- ⏳ 消息搜索（后端实现）
- ⏳ 历史消息分页加载 ✅ (已有实现: im-api/message.rs pagination)
...
#### 任务 124：代码质量改进 ✅ (2026-05-16)
- [x] 修复所有编译警告
- [x] 统一错误处理模式（替换 unwrap() 为安全错误处理）
- [ ] 代码注释完善
- [ ] 模块依赖优化
- [ ] 性能热点优化
